...
import sys
sys.path.insert(0, "//home/apprenant/simplon_project/API_REST/")
import pandas as pd
import numpy as np
import warnings
...
def import_database():
    database1 = pd.read_csv('/home/apprenant/simplon_project/API_REST/data/cleaned_emotion_final.csv')
    database2 = pd.read_csv('/home/apprenant/simplon_project/API_REST/data/cleaned_text_emotion.csv')
